...
def test_sparse_sgdm_step_applies_mask(tiny_mlp):
    ...
    # Wrap named parameters in a dict
    named_params = {name: param for name, param in model.named_parameters()}

    # Optimizer with masking
    optimizer = SparseSGDM(named_params, grad_mask=mask, lr=0.01)
